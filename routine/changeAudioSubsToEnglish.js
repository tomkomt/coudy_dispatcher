...
module.exports = () => {
    return new Promise((resolve, reject) => {
        ...
        series([
            ...
            (callback) => {
                let eng_subtitles = _.find(available_subtitles, subs => {
                    return _.get(subs, 'language') == 'eng';
                })
                if(eng_subtitles) {
                    unirest.post(configParams.getIn(['services', 'kodi_jsonrpc', 'url']))
                    .headers({
                    ...
                    .send({
                        ...
                        "params": {
                            "playerid": active_player_id,
                            "subtitle": _.get(eng_subtitles, 'index'),
                            "enable": true
                        },
                        "id": 1
                    })
            ...
            (callback) => {
                let eng_audiostream = _.find(available_audiostreams, subs => {
                    return _.get(subs, 'language') == 'eng';
                })
                if(eng_audiostream) {
                    unirest.post(configParams.getIn(['services', 'kodi_jsonrpc', 'url']))
                    ...
                    .send({
                        ...
                        "params": {
                            "playerid": active_player_id,
                            "stream": _.get(eng_audiostream, 'index')
                        },
                        "id": 1
                    })
                    .end((response) => {
